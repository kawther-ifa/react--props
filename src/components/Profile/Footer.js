  ...
  render() {
    ...
    return (
      <div className="container-1"style={{
        ...
        />
        <h3>
          <strong>kawther ifa</strong>
        </h3>
        <h4> Local : Main Street </h4>
        <h4>Email Id: kawtherifa42@gmail.com</h4>
        <a
          id="mail"
          href="https://mail.google.com/mail/?view=cm&fs=1&to=kawtherifa42@gmail.com"
        style={myStylea}>
          <img src="/images/mailmeimg.png" alt="mail me" style={styleImg} />
          Click Here To Send Mail
        </a>
        <h4>Contant Info: +221 94977032</h4>

        <a href="https://www.facebook.com/kawther ifa" style={myStylea}>
        ...
        <a href="https://github.com/ifa-kawther" style={myStylea}>
          <span className="icon fa fa-github" style={{ color: "antiquewhite" }}>
            <FaGithub />
          </span>
        </a>
        <a href="https://www.linkedin.com/in/kawther-ifa-477286146/" style={myStylea}>
          <span
